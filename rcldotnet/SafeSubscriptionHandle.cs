...
{
    /// <summary>
    /// Safe handle representing a rcl_subscription_t
    /// </summary>
    /// <summary>
    /// Since we need to delete the subscription handle before the node is released we need to actually hold a
    /// pointer to a rcl_subscription_t unmanaged structure whose destructor decrements a refCount. Only when
    ...
    { 
        ...
        //
        // Needed to change the exact order of statements in ReleaseOrder() as rcl_subscription_fini()
        ...
        protected override bool ReleaseHandle()
        {
            ...
            if (parent != null)
            {
                ...
                RCLRet ret = NodeDelegates.native_rcl_destroy_subscription_handle(handle, parent);
