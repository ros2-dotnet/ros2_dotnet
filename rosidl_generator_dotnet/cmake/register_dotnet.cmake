...
macro(rosidl_generator_dotnet_extras BIN GENERATOR_FILES TEMPLATE_DIR)
  ...
  ament_register_extension(
    ...
    "rosidl_generator_dotnet"
    "rosidl_generator_dotnet_generate_action_interfaces.cmake")

  normalize_path(BIN "${BIN}")
  set(rosidl_generator_dotnet_BIN "${BIN}")

  normalize_path(GENERATOR_FILES "${GENERATOR_FILES}")
  set(rosidl_generator_dotnet_GENERATOR_FILES "${GENERATOR_FILES}")

  normalize_path(TEMPLATE_DIR "${TEMPLATE_DIR}")
  set(rosidl_generator_dotnet_TEMPLATE_DIR "${TEMPLATE_DIR}")
endmacro()
